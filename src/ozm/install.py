...
- **Run commands:** `ozm cmd --agent-name "<work>" --agent-description "<intent>" <command> [args...]` — for arbitrary commands. Conservative `command -v`, `bazel query`, `brew search`, `npm view`, and `npm list` forms run as semantic reads.
