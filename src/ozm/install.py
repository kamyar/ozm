...
- **Typed GitHub writes:** use `ozm gh ... pr review-reply --repo OWNER/REPOSITORY --number NUMBER --comment-id ID --body-file FILE` for replies and `ozm gh ... issue add-sub-issue --repo OWNER/REPOSITORY --parent NUMBER --sub-issue-id ID` for sub-issue links. Equivalent raw POST requests are blocked.
